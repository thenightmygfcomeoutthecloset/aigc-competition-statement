...
从最终作品、作品分析与用户确认信息生成完整的过程说明包：视觉创作过程、Prompt/参数记录、Stage Graph、严格 Manifest 和 A4 DOCX。
...
- sketch、lineart、color block 仅是前期视觉设计，永远不作为 generation version。
...
- 创作工具由用户在开始时提供，写入 DOCX 第七章「创作工具说明」；未提供时省略该章。
